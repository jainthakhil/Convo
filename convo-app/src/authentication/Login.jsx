    ...
    <>
      ...
      >
        ...
        <div className="mt-4 flex flex-col items-center justify-center">
          ...
          <button className="text-white md:px-10 px-8 py-2 mt-4 rounded-3xl md:border-4 border-3 border-black font-semibold bg-[linear-gradient(to_right,_#2A7B9B_0%,_#57C785_50%,_#EDDD53_100%)] hover:opacity-90 transition">Submit</button>
          <p className="text-white md:text-base text-sm mt-2">New to Convo? <a className='underline' href="/">Signup</a></p>
        </div>
      </div>
    </>
  );
