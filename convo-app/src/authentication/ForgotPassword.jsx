      ...
      >
        ...
        <div className="mt-6 relative w-fit items-center justify-center mx-auto">
          ...
          <Box
            ...
            className="bg-yellow-300 w-65 md:w-95 rounded-lg flex flex-col shadow-lg relative z-0"
          >
            <h1 className="font-bold font-akaya text-center">
              Oops! It seems like you forgot your password. Don’t worry! Just
        ...
        <div className="mt-4 flex flex-col items-center justify-center">
          <Box
            component="section"
            sx={{ p: 1, border: "4px solid black" }}
            className="w-65 md:w-95 bg-white rounded-lg flex flex-col items-center justify-center shadow-lg"
          >
          ...
          <button className="text-white md:px-10 px-8 py-2 mt-4 rounded-3xl border-3 border-black font-semibold bg-[linear-gradient(to_right,_#2A7B9B_0%,_#57C785_50%,_#EDDD53_100%)] hover:opacity-90 transition">
            Submit
          </button>
